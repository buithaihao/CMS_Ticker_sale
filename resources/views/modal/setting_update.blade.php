            ...
            <div class="modal-content" style="border: none; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5);">
                ...
                <div class="content-body" style="padding-left: 20px; padding-right: 20px; font-weight: 600;">
                    <p>Tên gói vé: <span class="text-danger">*</span> <br>
                        <input type="text" class="nhap" name="goive" id="goive" placeholder="Nhập tên gói vé" style="color: #afaaa7;">
                    </p>

                    <div style="display: flex;">
                        <p>Ngày áp dụng: <br>
                            <span class="dropdown-icon-date-setting">
                                <input type="text" class="dropd-ticket-date-setting dategranttime" name="dategranttime"  id="dategranttime" placeholder="mm/dd/yyyy">
                        ...
                        <p style="padding-left: 20px;">Ngày hết hạn: <br>
                            <span class="dropdown-icon-date-setting">
                                <input type="text" class="dropd-ticket-date-setting dateexpiry" name="dateexpiry" id="dateexpiry" placeholder="mm/dd/yyyy">
                    ...
                    <p>Giá vé áp dụng: <br>
                        <div>
                            ...
                            <div class="wrapper" style="margin-top: 10px;">
                                ...
                                <input type="text" id="combo3" class="dropd-ticket-date" name="giavecombo" placeholder="Giá vé" style="margin-left: 10px; margin-right: 10px; width: 130px; height: 40px;" disabled> <span style="color: #000; font-weight: 400;">/</span> 
                                <input type="text" id="combo4" class="dropd-ticket-date" name="soluong" placeholder="Giá vé" style="margin-left: 10px; margin-right: 10px; width: 60px; height: 40px;" disabled> <span style="color: #000; font-weight: 400;">vé</span>      
                            </div>
                        </div>
                    </p>
                    <p>Tình trạng: <br>
